...
const DocsCode = ({
  ...
  return (
    <CodeBlock code={code} language={language}>
      <CodeBlock.Code
        className={cn(
          'overflow-x-auto overflow-y-hidden rounded-lg bg-zinc-800 px-3 py-2 shadow-lg scrollbar-thin selection:bg-muted selection:text-muted-foreground dark:bg-zinc-900 dark:selection:bg-primary dark:selection:text-muted',
          format === 'txt' &&
